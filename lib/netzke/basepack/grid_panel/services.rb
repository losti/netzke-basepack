      ...
      module Services
        ...
        included do
          ...
          endpoint :get_combobox_options do |params|
            ...
            scope = params[:scope] || column.to_options[:scope] || column.to_options[:editor].try(:fetch, :scope, nil)
            query = params[:query]
        ...
        protected
          ...
          def get_records(params)
            ...
            params[:after_sort] = config[:after_sort]
            params[:default_sort] = config[:default_sort]
